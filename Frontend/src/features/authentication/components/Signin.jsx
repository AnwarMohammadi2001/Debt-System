    ...
    <div className="flex justify-center items-center min-h-screen bg-white p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <form
          ...
          className="bg-gray-200 backdrop-blur-sm rounded-md p-8 space-y-6 transform hover:shadow-xl transition-all duration-300 border border-white/20"
        >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-5 focus:outline-none rounded-lg border border-gray-300 focus:ring-1 focus:ring-cyan-600  transition-all duration-200 bg-gray-50 text-right hover:bg-white shadow-sm"
                dir="rtl"
              />
