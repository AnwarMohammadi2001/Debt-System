...
const CustomerPrintPaymentReceipt = ({
  isOpen,
  onClose,
  paymentData,
  customerData,
  ...
  if (!isOpen || !paymentData || !customerData) {
    return null;
  }
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center border-b border-dashed border-gray-300 pb-2">
                ...
                <span className="font-bold text-blue-700">
                  {formatCurrency(walletStats?.totalDebt || 0)}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center pt-1">
                <span
                  className={`font-bold text-lg ${(walletStats?.balance || 0) > 0 ? "text-red-700" : "text-green-700"}`}
                >
                  باقی‌مانده کل:
                </span>
                <span
...
export default CustomerPrintPaymentReceipt;
