    ...
    <div className="min-h-screen bg-gray-200 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="gap-8">
          ...
          <div className="bg-gray-100 max-w-4xl mx-auto rounded-lg shadow-lg p-6 transition-all duration-300 border border-white/20">
          ...
          <div className="mt-5 p-6 bg-gray-100 rounded-md transition-all duration-300 border-white/20">
