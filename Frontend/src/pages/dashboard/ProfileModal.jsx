...
const ProfileModal = ({ isOpen, onClose, currentUser }) => {
  ...
  return (
    ...
    >
      <div
        dir="rtl"
        className="bg-gray-200 backdrop-blur-lg rounded-md shadow-2xl p-6 w-full max-w-md relative
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-gray-200/80 rounded-lg shadow-sm
          ...
          {/* Buttons */}
          <div className="flex justify-center gap-3 pt-4 border-t border-white/30 mt-4">
            <button
              type="submit"
              className="px-4 py-2 bg-cyan-700 text-white/95
                       rounded-md hover:bg-cyan-800 cursor-pointer shadow-md
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 bg-red-600 backdrop-blur-sm
                       text-gray-100 rounded-lg hover:bg-red-800 cursor-pointer
